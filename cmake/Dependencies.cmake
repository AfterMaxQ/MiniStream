...
if(WIN32)
  ...
  if(MINISTREAM_ENABLE_PACKAGING AND NOT MINISTREAM_HAVE_NVENC_SDK)
    message(FATAL_ERROR "Windows packages require MINISTREAM_NVENC_SDK_ROOT with Interface/nvEncodeAPI.h")
  endif()
